<#
Install Claude Office's Codex hooks in the current user's global Codex layer.
...
$launcher = @'
<# Claude Office global Codex hook launcher. Generated by install-global-hooks.ps1. #>
...
Write-Host "Claude Office のCodex global hooksをインストールしました。"
