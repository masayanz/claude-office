...
const es: Record<TranslationKey, string> = {
  ...
  "header.aiOff": "OFF",
  "header.codex": "CODEX",
  "header.codexLive": "EN VIVO",
  "header.codexWaiting": "EN ESPERA",
  "header.codexRestored": "SOLO RESTAURADO",
  "header.codexLastEvent": "Último evento: {time}",
  "header.codexNoEvents": "Último evento: ninguno",
  "header.codexLiveEventCount": "Eventos en vivo: {count}",
